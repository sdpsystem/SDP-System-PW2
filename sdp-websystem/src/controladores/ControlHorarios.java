...
public class ControlHorarios extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if(email.equals("madara.sdp@gmail.com")){
			RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/jsp/AdministrarHorarios.jsp");
			rd.forward(req, resp);
		}else{
		...
		if(a.getRecursos().getHorarios()==true){
			RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/jsp/AdministrarHorarios.jsp");
			rd.forward(req, resp);
		}else{
